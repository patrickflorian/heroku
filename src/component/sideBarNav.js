...
class SideBarNav extends Component{
    ...
    render(){
        return (
                    ...
                    {(this.state.activeMenuItem==="user") ?<NavItem title="UTILISATEURS" icon={user2} onClick={()=>this._toggleActiveMenu('user')} active={true}></NavItem>:<NavItem title="UTILISATEURS" icon={user2} onClick={()=>this._toggleActiveMenu('user')} active={false}></NavItem>}
