...
class PositionTable extends React.Component {
    ...
    showLocationForm(){
        ...
        return <LocationForm onClose={()=> this.props.dispatch({type:'TOGGLE_FORM_AREA_VISIBILITY',value:false})}>
                </LocationForm>
                        ...
                        <table className="table-striped">
                            ...
                            <tbody>
                                {locations.items && locations.items.map((location,i) =>
                                    <tr key={i}>
                                        <td></td>  
                                        <td className="xs-hide">{location.longitude}</td>
                                        <td className="xs-hide">{location.latitude}</td>
